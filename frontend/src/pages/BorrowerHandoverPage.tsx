    ...
    return (
        <div className="max-w-xl mx-auto px-4 py-8 flex flex-col gap-4">
                ...
                <div className="glass-panel rounded-3xl p-5 flex items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs text-[var(--muted)] mt-0.5">
                            Concreta los detalles de la entrega con el propietario por el chat.
                        </p>
                    </div>
                    <Link
            ...
            <div className="glass-panel rounded-3xl p-8">
                ...
                <h1 className="font-editorial text-2xl font-semibold mb-2">Código de entrega</h1>
                {listingTitle && <p className="text-sm text-[var(--muted)] mb-1">{listingTitle}</p>}
