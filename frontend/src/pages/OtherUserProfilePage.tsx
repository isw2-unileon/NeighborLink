                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-xs text-[var(--muted)] mt-0.5">
                                                    Depósito: {listing.deposit_amount}€
                                                </p>
                                            </div>

                                            <span
                                                className={`text-xs px-2 py-0.5 rounded-full font-medium flex-shrink-0 ${STATUS_COLORS[listing.status] ?? 'bg-gray-100 text-gray-600'
                                                    }`}
                                            >
