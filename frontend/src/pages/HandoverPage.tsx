...
export default function HandoverPage() {
    ...
    useEffect(() => {
        ...
        api.get<{ data: { id: string; status: string; deposit_amount_cents?: number }[] }>(
            ...
            const active = r.data.find(t => t.status === 'agreed');
            if (active) {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        setError(null);
        try {
            await api.post(`/transactions/${transactionId}/confirm-handover`, {
                code,
    ...
    return (
        <div className="max-w-xl mx-auto px-4 py-8 flex flex-col gap-4">
            ...
            <div className="glass-panel rounded-3xl p-8">
                ...
                <h1 className="font-editorial text-2xl font-semibold mb-2">Confirmar entrega</h1>
